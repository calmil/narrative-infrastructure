...
interaction_anim =  pyglet.image.Animation.from_image_sequence(interaction_seq[0:], 0.03, loop=False)
...
symbolic_anim =  pyglet.image.Animation.from_image_sequence(symbolic_seq[0:], 0.03, loop=False)