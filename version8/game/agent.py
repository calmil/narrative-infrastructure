...
class Agent(pyglet.sprite.Sprite):
    ...
    def check_bounds(self):
        ...
        max_x = self.window_width + self.image.width / 2
        max_y = self.window_height + self.image.width / 2
    ...
    def interacts_with(self, other_agent):
        ...
        if actual_distance <= self.image.width * _SEPARATION_RADIUS:
            ...
            if self.interaction_timers[other_agent.id] > 200:
    ...
    #     trade_history += str(self.name) + " and " + str(other_agent.name)
